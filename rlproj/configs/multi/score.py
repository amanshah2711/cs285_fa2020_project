"""Named configs for rlproj.multi.score."""
...
from rlproj.configs.multi.common import BANSAL_GOOD_ENVS, get_adversary_paths
...
logger = logging.getLogger("rlproj.configs.multi.score")
