"""Named configs for rlproj.multi.train."""
...
from rlproj.configs.multi.common import BANSAL_ENVS, BANSAL_GOOD_ENVS, get_adversary_paths
from rlproj.envs import VICTIM_INDEX, gym_compete
from rlproj.train import PAPER_HYPERPARAMS, SPARSE_REWARD
