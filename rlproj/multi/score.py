"""Hyperparameter search for adversarial_train.py using Ray Tune."""
...
from rlproj.configs.multi.score import make_configs
from rlproj.envs import VICTIM_INDEX
from rlproj.envs.gym_compete import env_name_to_canonical
from rlproj.multi import common, score_worker
from rlproj.score_agent import score_ex

multi_score_ex = Experiment("multi_score", ingredients=[score_ex])
pylog = logging.getLogger("rlproj.multi.score")
...
def run_external(named_configs, post_named_configs, config_updates, adversary_path=None):
    ...
    # see rlproj.configs.multi.score:_get_adversary_paths
